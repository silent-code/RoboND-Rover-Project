...
# Identify rock samples in yellow 
...
def perception_step(Rover):
    ...
    navigable_terrain = color_thresh(warped, rgb_thresh=rgb_threshold)
    obstacle_terrain = 1 - navigable_terrain
    ...
    obstacle_x_rover, obstacle_y_rover = rover_coords(obstacle_terrain)
    ...
    dist_to_rocks, angles_to_rocks = to_polar_coords(rock_x_rover, rock_y_rover)
    dist_to_navigable_terrain, angles_to_navigable_terrain = to_polar_coords(navigable_x_rover, navigable_y_rover)
