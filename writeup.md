...
**Training / Calibration: Stage 1 of the RoboND Rover Project**  
...
* Finally I used the `moviepy' module to process the images in your saved dataset with the `process_image()` function.  The final video can be found in the output folder of this repository.
